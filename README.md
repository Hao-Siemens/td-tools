...
-   [LoRaWAN Payload Decoder](https://github.com/eclipse-thingweb/td-tools/tree/main/python/lorawan): Describing a LoRaWAN payload binding inside a TD, converting it to a LoRa-Alliance payload schema, decoding uplinks and generating ChirpStack/TTN JavaScript codecs (Python)
